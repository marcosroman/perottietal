...
#edgesfilename="data/network-2_n-5000_l-2_mu-0.01.edges"
#edgesfilename="tests/network-10_n-5000_l-2_mu-0.3_p-0.77.edges"
#N=5000
#edgesfilename="tests/network-9_n-5000_l-2_mu-0.7_p-1_preplica-0.7_realnumber-3589.edges"
#edgesfilename="tests/network-7_n-5000_l-2_mu-0.3_p-1_preplica-0.25_realnumber-1747.edges"
#edgesfilename="tests/network-5_n-5000_l-2_mu-0.7_p-0.73.edges"
#data/network-3_n-5000_l-2_mu-0.01.edges
#N=1747
#N=5000
N,neighbors=getNneighbors(edgesfilename)
layerbasefilename=edgesfilename+"_oslom2modbp_files/l"
...
for i in range(N):
    ...
    if len(paths)==1:
        ...
        finalpath.append(random.choice(filter(filter_allowed_paths, paths)))
    print i,"::",finalpath[-1]
